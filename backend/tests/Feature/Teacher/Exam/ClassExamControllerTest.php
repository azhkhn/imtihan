...
namespace Tests\Feature\Teacher\Exam;
...
class ClassExamControllerTest extends TestCase
{
    ...
    protected string $apiUrl = '/api/teacher/exam/classes/';
    ...
    public function test_class_exam_list()
    {
        ...
        Sanctum::actingAs($user, ['teacher.class-exam.list']);
    ...
    public function test_class_exam_create()
    {
        ...
        Sanctum::actingAs($user, ['teacher.class-exam.create']);
    ...
    public function test_class_exam_show()
    {
        ...
        Sanctum::actingAs($user, ['teacher.class-exam.show']);
    ...
    public function test_class_exam_update()
    {
        ...
        Sanctum::actingAs($user, ['teacher.class-exam.update']);
    ...
    public function test_class_exam_delete()
    {
        ...
        Sanctum::actingAs($user, ['teacher.class-exam.delete']);
