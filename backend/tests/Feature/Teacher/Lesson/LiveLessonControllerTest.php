...
class LiveLessonControllerTest extends TestCase
{
    ...
    protected string $apiUrl = '/api/teacher/live-lessons/';
    ...
    public function test_live_lesson_list()
    {
        ...
        Sanctum::actingAs($user, ['teacher.live-lesson.list']);
    ...
    public function test_live_lesson_show()
    {
        ...
        Sanctum::actingAs($user, ['teacher.live-lesson.show']);
    ...
    public function test_live_lesson_update()
    {
        ...
        Sanctum::actingAs($user, ['teacher.live-lesson.update']);
    ...
    public function test_live_lesson_delete()
    {
        ...
        Sanctum::actingAs($user, ['teacher.live-lesson.delete']);
