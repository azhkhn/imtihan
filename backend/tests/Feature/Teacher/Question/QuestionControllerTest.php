...
namespace Tests\Feature\Teacher\Question;
...
class QuestionControllerTest extends TestCase
{
    ...
    protected string $apiUrl = '/api/teacher/questions/';
    ...
    public function test_question_list()
    {
        ...
        Sanctum::actingAs($user, ['teacher.question.list']);
    ...
    public function test_question_create()
    {
        ...
        Sanctum::actingAs($user, ['teacher.question.create']);
    ...
    public function test_question_show()
    {
        ...
        Sanctum::actingAs($user, ['teacher.question.show']);
    ...
    public function test_question_update()
    {
        ...
        Sanctum::actingAs($user, ['teacher.question.update']);
    ...
    public function test_question_delete()
    {
        ...
        Sanctum::actingAs($user, ['teacher.question.delete']);
    ...
    public function test_question_bug_list()
    {
        ...
        Sanctum::actingAs($user, ['teacher.question.bug.list']);
    ...
    public function test_question_bug_delete()
    {
        ...
        Sanctum::actingAs($user, ['teacher.question.bug.delete']);

        $response = $this->delete('/api/teacher/question/bugs/'.$bug->id);
