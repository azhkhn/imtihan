...
use App\Http\Resources\Teacher\Exam\ReportResource;
use App\Services\Teacher\Exam\ReportService;
...
class ReportController extends ApiController
{
    ...
    {
        abort_unless(auth()->user()->tokenCan('teacher.exam.report.list'),
    ...
    {
        abort_unless(auth()->user()->tokenCan('teacher.exam.report.show'),
            Response::HTTP_FORBIDDEN
        );
